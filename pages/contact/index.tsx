...
const Contact = () => {
  return (
    <section className="w-full bg-gray-800 flex justify-center">
      <div className="bg-white max-w-2xl px-6 py-4 my-4 rounded-md shadow-md">
        ...
        <div className="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-3">
          <a
            href="#"
            className="flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-200 transform rounded-md hover:bg-gray-400"
          >
            <svg
              className="w-5 h-5"
            ...
            <span className="mt-2">London</span>
          </a>
          <a
            href="#"
            className="flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-200 transform rounded-md hover:bg-gray-400"
          >
            ...
            <span className="mt-2">+447473057132</span>
          </a>
          <a
            href="#"
            className="flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-200 transform rounded-md hover:bg-gray-400"
          >
            ...
            <span className="mt-2">danielmartin1996@hotmail.com</span>
          </a>
        </div>
        <div className="mt-6 ">
